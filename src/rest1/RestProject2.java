...
public class RestProject2 {
    ...
    public void soaptest() throws XmlException, IOException, SoapUIException {
        ...
        WsdlProject project = new WsdlProject("C:\\Users\\dwija\\OneDrive\\Desktop\\SoapUI Projects\\REST-Project-2-soapui-project.xml");
        
        // Get the Test Suite by name
        WsdlTestSuite testSuite = project.getTestSuiteByName("Full E2E");
